...
public class Create_tables {
    ...
    public void create_tables() throws Exception{
        ...
        String class_stu="create table class(class_id int primary key,class_name" +
                " Text not null,courseID Text ,capacity int ,foreign key(courseID) references course,unique(class_name,courseID,capacity));";  //加上teacher 会有麻烦,, unique(class_name,courseID) 傻逼玩意不满足去掉了
